...
const entityUrl = isVBRoute ? '/api/visuals/?tags=author%2Cdashboard&page=0&size=10000' : '/api/dashboards';
const componentType = isLiteRoute ? 'lite-dashboard' : isVBRoute ? 'visual-builder': 'dashboard';
